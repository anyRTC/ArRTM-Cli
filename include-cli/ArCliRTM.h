...
#include "ArCliRTMEventHandler.h"
#include "ArCliRTMChannel.h"
#include "ArCliRTMCallManager.h"
...
namespace ArCliLibrary {
	...
	public:
		...
		//频道属性增删改查
		ArCliLibrary::ClrRtmChannelAttribute^ createChannelAttribute();
		...
		//加入离开频道相关
		ArCliRTMChannel^ createChannel(String^ id);

		//呼叫邀请管理
		ArCliRTMCallManager^ getRtmCallManager();
	...
	private:
		IRtmService* service;
		ArCliRTMEventHandler* rtmEvents;
		ArCliRTMCallManager^ manager;
